...
import { ChevronsLeft, Plus, MenuIcon, PlusCircle, Search, Settings, Trash } from "lucide-react";
    ...
    <>
      <aside 
        ...
        <div
          ...
          role="button"
          className={cn(
            "group-hover/sidebar:opacity-100 h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3  right-2 opacity-0",
